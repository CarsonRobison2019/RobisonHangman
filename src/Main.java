    ...
    public static void main(String[] args) {
        ...
        String[] words = {"nail","silk","numberless","sloppy","military","necessary","injure","field","boorish", "inject",
               ...
               "eggs", "fear", "long", "pathetic", "overrated", "adamant", "toothbrush", "hour", "crazy", "flowery", "dust",
                ...
                "watch", "thaw", "hand", "punish", "cast", "fact", "understood", "thankful", "poke", "public", "copy",
                "helpful", "vigorous", "knit", "shave", "endurable", "challenge", "can", "strap", "girl", "wrap",
                "toys", "limping", "disapprove", "crow", "servant", "pear", "ahead", "inconclusive", "help", "driving",
                "dispensable", "hammer", "oval", "star", "vessel", "calm", "nine", "agonizing", "meat", "grate",
                "unequaled", "bag", "zoo", "simple", "dust", "resonant", "finger", "save", "right", "bitter",
                "shiny", "whispering", "wacky", "bang", "charge", "spicy", "bleach", "changeable",
                "soothe", "acoustics", "nutritious", "tense", "stamp", "giraffe", "thunder", "four", "holiday",
                "support", "yawn", "school", "resolute", "push", "past", "cent", "ball", "nose", "head",
                "husky", "island", "color", "whip", "protect", "steer", "mate", "used", "blink", "man", "surprise",
                ...
                "colorful", "badge", "clear", "stove", "jagged", "efficacious", "accept", "nerve", "historical", "mixed",
                "discovery", "feigned", "parcel", "abaft", "morning", "blushing", "terrible", "adjustment", "pine",
                "start", "taste", "idiotic", "soap", "writing", "turn", "omniscient", "letters", "home", "busy", "rabbits", "sound",
                "tie", "satisfying", "serve", "dolls", "anger", "foot", "judge", "ghost", "creepy", "irate", "distribution",
                "superficial", "true", "scarf", "wandering", "wrong", "pest", "abhorrent", "electric", "appear", "silky",
                "handsomely", "expect", "peace", "sheet", "deadpan", "curly", "cap", "ignorant", "various", "boring", "wipe",
                "detailed", "wash", "mine", "dramatic", "complete", "person", "loud", "big", "guess", "aunt", "raspy", "weary",
                "scrub", "coherent", "unnatural", "pickle", "bells", "absorbing", "seemly", "hop", "flashy", "offbeat", "box",
